...
import com.self.myapp.config.audit.AuditEventConverter;
import com.self.myapp.domain.PersistentAuditEvent;
import com.self.myapp.repository.PersistenceAuditEventRepository;

import com.self.myapp.service.AuditEventService;
